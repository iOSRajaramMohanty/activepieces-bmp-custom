...
exports.adaBmpTemplate = exports.adaBmpTemplateCategory = exports.adaBmpContactCategory = exports.messageType = exports.otpText = exports.messageText = exports.recipientManual = exports.recipientFromList = exports.recipientInputType = exports.adaBmpAccount = exports.adaBmpChannelForBulk = exports.adaBmpChannel = exports.channelInfo = exports.CHANNEL_TO_PLATFORM = void 0;
 ...
 */
exports.CHANNEL_TO_PLATFORM = {
    'Whatsapp': 'WA',
    'Facebook': 'FB',
    'Instagram': 'IG',
    'Line': 'LINE',
};
exports.channelInfo = pieces_framework_1.Property.MarkDown({
    value: `
**Channel Selection**
...
const adaBmpChannel = (required) => pieces_framework_1.Property.Dropdown({
    ...
    async options({ auth, server, project }) {
        ...
        try {
            ...
            const apiUrl = config_1.API_ENDPOINTS.getChannels(metadata, auth);
            (0, config_1.debugLog)('Fetching channels from /account', { url: apiUrl, hasMetadata: !!metadata }, metadata);
            ...
            (0, config_1.debugLog)('Account response received', { status: response.status });
            ...
            if (!body.data || body.data.length === 0) {
                (0, config_1.debugLog)('No accounts found in response');
                return {
                    disabled: true,
            ...
            if (channels.length === 0) {
                (0, config_1.debugLog)('No valid channels found');
                return {
                    disabled: true,
                    placeholder: 'No channels found',
                    options: [],
            ...
            (0, config_1.debugLog)('Channels extracted successfully', { count: channels.length, channels });
            return {
                disabled: false,
            ...
            (0, config_1.debugLog)('Failed to fetch channels', error);
            return {
                disabled: true,
...
exports.adaBmpChannel = adaBmpChannel;
const adaBmpChannelForBulk = (required) => pieces_framework_1.Property.Dropdown({
    auth: index_1.adaBmpAuth,
    displayName: 'Channel',
...
exports.adaBmpChannelForBulk = adaBmpChannelForBulk;
const adaBmpAccount = (required) => pieces_framework_1.Property.Dropdown({
    auth: index_1.adaBmpAuth,
    displayName: 'Account',
    ...
    async options({ auth, channel, server, project }) {
        ...
        try {
            ...
            const platformCode = exports.CHANNEL_TO_PLATFORM[channel];
            if (!platformCode) {
                (0, config_1.debugLog)('Unknown channel', { channel }, metadata);
                return {
                    disabled: true,
            ...
            const apiUrl = config_1.API_ENDPOINTS.getAccounts(platformCode, metadata, auth);
            (0, config_1.debugLog)('Fetching accounts', { url: apiUrl, platform: platformCode, hasMetadata: !!metadata }, metadata);
            ...
            (0, config_1.debugLog)('Accounts response received', { status: response.status });
            // Parse the response
            // Response structure: { status, message, data: [ { id, name, accountNo, ... } ], pageNo, pageSize, pageTotal, totalRecord }
            const body = response.body;
            if (!body.data || body.data.length === 0) {
                (0, config_1.debugLog)('No accounts found', { platform: platformCode });
                return {
                    disabled: true,
            ...
            (0, config_1.debugLog)('Accounts fetched successfully', { count: accounts.length });
            return {
                disabled: false,
            ...
            (0, config_1.debugLog)('Failed to fetch accounts', error);
            return {
                disabled: true,
...
exports.adaBmpAccount = adaBmpAccount;
exports.recipientInputType = pieces_framework_1.Property.StaticDropdown({
...
const recipientFromList = (required) => pieces_framework_1.Property.Dropdown({
    auth: index_1.adaBmpAuth,
    ...
    async options({ auth, channel, account, server, project }) {
        ...
        try {
            ...
            if (!selectedAccount) {
                (0, config_1.debugLog)('Selected account not found', { accountId: account }, metadata);
                return {
                    disabled: true,
            ...
            (0, config_1.debugLog)('Fetching recipients', { url: apiUrl, accountNo: selectedAccount.accountNo, platform: platformCode, hasMetadata: !!metadata }, metadata);
            const response = await pieces_common_1.httpClient.sendRequest({
                method: pieces_common_1.HttpMethod.GET,
                url: apiUrl,
                authentication: {
            ...
            (0, config_1.debugLog)('Recipients response received', { status: response.status });
            // Parse the response structure
            const body = response.body;
            if (!body.data || body.data.length === 0) {
                (0, config_1.debugLog)('No recipients found', { platform: platformCode });
                return {
                    disabled: false,
            ...
            (0, config_1.debugLog)('Recipients fetched successfully', { count: recipients.length });
            return {
                disabled: false,
            ...
            (0, config_1.debugLog)('Failed to fetch recipients', error);
            return {
                disabled: true,
...
exports.recipientFromList = recipientFromList;
const recipientManual = (required) => pieces_framework_1.Property.ShortText({
...
exports.recipientManual = recipientManual;
exports.messageText = pieces_framework_1.Property.LongText({
    displayName: 'Message',
    description: 'The message text to send. You can use variables from previous steps like {{previousStep.fieldName}}',
    required: true,
});
exports.otpText = pieces_framework_1.Property.ShortText({
    displayName: 'OTP',
    description: 'Enter the OTP value for authentication template',
    required: true,
});
exports.messageType = pieces_framework_1.Property.StaticDropdown({
...
const adaBmpContactCategory = (required) => pieces_framework_1.Property.Dropdown({
    auth: index_1.adaBmpAuth,
    ...
    async options({ auth, channel, server, project }) {
        ...
        try {
            ...
            const platformCode = exports.CHANNEL_TO_PLATFORM[channel];
            if (!platformCode) {
                (0, config_1.debugLog)('Unknown channel', { channel, availableChannels: Object.keys(exports.CHANNEL_TO_PLATFORM) }, metadata);
                return {
                    disabled: true,
            ...
            const apiUrl = config_1.API_ENDPOINTS.getContactCategories(platformCode, metadata, auth);
            (0, config_1.debugLog)('Fetching contact categories', { url: apiUrl, platform: platformCode, hasMetadata: !!metadata }, metadata);
            // Fetch contact categories from the API
            let response;
            try {
                response = await pieces_common_1.httpClient.sendRequest({
                    method: pieces_common_1.HttpMethod.GET,
                    url: apiUrl,
                    authentication: {
                        type: pieces_common_1.AuthenticationType.BEARER_TOKEN,
                ...
                (0, config_1.debugLog)('HTTP request failed', requestError);
                throw new Error(`Failed to fetch contact categories: ${requestError?.message || 'Network error'}`);
            }
            (0, config_1.debugLog)('Contact categories response received', { status: response.status });
            ...
            try {
                ...
                (0, config_1.debugLog)('Failed to parse response body', parseError);
            ...
            if (!body.data || body.data.length === 0) {
                (0, config_1.debugLog)('No contact categories found', { platform: platformCode });
                return {
                    disabled: false,
            ...
            (0, config_1.debugLog)('Contact categories fetched and sorted successfully', { count: categories.length });
            ...
            const options = validCategories
                ...
                try {
                    ...
                    (0, config_1.debugLog)('Error mapping category', { category, error: err });
                    return null;
                }
            })
                .filter((option) => {
            ...
            (0, config_1.debugLog)('Failed to fetch contact categories', error);
            ...
            return {
                ...
                options: [], // Explicitly type the empty array
            };
        }
    },
});
exports.adaBmpContactCategory = adaBmpContactCategory;
...
exports.adaBmpTemplateCategory = pieces_framework_1.Property.Dropdown({
    auth: undefined,
...
const adaBmpTemplate = (required) => pieces_framework_1.Property.Dropdown({
    auth: index_1.adaBmpAuth,
    ...
    async options({ auth, account, messageType, templateCategory, server, project }) {
        ...
        try {
            ...
            const contextProject = project;
            const metadata = await (0, config_1.fetchMetadata)(contextProject?.id, contextServer, pieces_common_1.httpClient, auth);
            const apiUrl = config_1.API_ENDPOINTS.getTemplates(account, metadata, auth);
            (0, config_1.debugLog)('Fetching templates', { url: apiUrl, accountId: account, hasMetadata: !!metadata }, metadata);
            ...
            (0, config_1.debugLog)('Templates response received', { status: response.status });
            // Parse the response
            // Response structure: { status, message, data: [ { id, name, status, createdDate, ... } ], pageNo, pageSize, pageTotal, totalRecord }
            const body = response.body;
            if (!body.data || body.data.length === 0) {
                (0, config_1.debugLog)('No templates found', { accountId: account });
                return {
                    disabled: false,
            ...
            (0, config_1.debugLog)('Templates fetched successfully', {
                count: templates.length,
                category: selectedCategory,
                filteredFrom: body.data.length,
                sortedBy: 'createdDate (newest first)'
            ...
            (0, config_1.debugLog)('Failed to fetch templates', error);
            return {
                disabled: true,
...
exports.adaBmpTemplate = adaBmpTemplate;
