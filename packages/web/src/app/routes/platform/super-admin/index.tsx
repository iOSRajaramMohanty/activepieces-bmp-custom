          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {statsLoading ? '...' : (() => {
                ...
                // Sum all role counts
                const displayedTotal = superAdmins + owners + admins + operators + members;
                  ...
                  },
                  {
                    ...
                    cell: ({ row }) => (
                      <PlatformActionsCell
                        ...
                        onSwitch={(platformId) => switchToTenantMutation.mutate(platformId)}
                        onDelete={(platformId) => deleteTenantMutation.mutate(platformId)}
