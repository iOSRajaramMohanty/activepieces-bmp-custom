...
export enum PlatformRole {
    /**
     * Super admin with full control across all tenants/platforms
     */
    SUPER_ADMIN = 'SUPER_ADMIN',
    /**
     * Tenant owner (BMP: organization owner) with full control over their org
     */
    OWNER = 'OWNER',
    /**
...
export const User = z.object({
    ...
    organizationId: Nullable(z.string()),
    clientId: Nullable(z.string()),
...
export const UserWithMetaInformation = z.object({
    ...
    organizationId: Nullable(z.string()),
    organizationName: Nullable(z.string()),
    environment: Nullable(z.string()),
})
