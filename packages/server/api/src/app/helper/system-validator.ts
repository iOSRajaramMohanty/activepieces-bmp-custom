...
const systemPropValidators: {
    ...
    [AppSystemProp.DEV_ALLOW_MULTIPLE_SIGNUPS]: booleanValidator,
    [AppSystemProp.DEV_PIECES]: stringValidator,
    [AppSystemProp.MULTI_TENANT_MODE]: booleanValidator,
    [AppSystemProp.PUBLIC_SIGNUP_ENABLED]: booleanValidator,
