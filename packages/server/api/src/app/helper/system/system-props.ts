...
export enum AppSystemProp {
    ...
    BMP_ORGANIZATIONS_ENABLED = 'BMP_ORGANIZATIONS',
    BMP_SUPER_ADMIN_ENABLED = 'BMP_SUPER_ADMIN',
    BMP_ACCOUNT_SWITCHING_ENABLED = 'BMP_ACCOUNT_SWITCHING',
    ...
    DEV_ALLOW_MULTIPLE_SIGNUPS = 'DEV_ALLOW_MULTIPLE_SIGNUPS',
